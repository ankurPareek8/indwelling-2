...
<head>
    ...
    <meta charset="UTF-8">
    <title> InDwelling | Christian Arts </title>

    <link rel= "stylesheet" type = "text/CSS" href = "christianarts.css">
...
<ul>
  ...
  <a href="index.html">
  <img src="Images/home/indwelling-logo-black.png" class="websitelogo" alt="websitelogo"/>
  </a>
             ...
             <img class="productimg" src="<?php echo $row["img"]; ?>"/>
              ...
              <p><strong>Product Name: </strong><?php echo $row["productName"]; ?></p>
               ...
               <!-- LINK TO VIEW MOVIE FOR MORE INFORMATION -->
                      <a href="view.php?<?php echo $row["id"]; ?>" class="view">View Product</a>
                  </div>
                      </div>
          <?php        
           }
